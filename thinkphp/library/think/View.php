...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        $baseReplace = [
            ...
            '__STATIC__' => $root . '/static/admin/lib',
			// '__USERCSS__'    => $root . '/static/admins/css',
			// '__USERJS__'    => $root . '/static/admins',
            '__CSS__'    => $root . '/static/admin/css',
            '__JS__'     => $root . '/static/admin/js',
			'__INDEXCSS__'=> $root . '/static/index/css',
			'__INDEXJS__'=> $root . '/static/index/js',
			'__LIB__'=> $root . '/static/index/lib',
			'__INDEXIMG__'=> $root . '/static/index/images',
			'__GJSCSS__' => $root . '/static/admin/assets',
			'__KINDEDITOR__' => $root . '/static/admin/kindeditor',
			// '__ADMINIMG__'    => $root . '/static/admin2/images',
			'__LAYUI__' => $root . '/static/layui',
        ];
          $this->replace = array_merge($baseReplace,Config::get('view_replace_str')?:[], (array) $replace);
    }
